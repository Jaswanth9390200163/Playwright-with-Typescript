...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e163]:
    - generic [ref=e164] [cursor=pointer]:
      ...
      - generic [ref=e165]:
        - button "Minimize" [ref=e166]: –
        - button "Maximize" [ref=e167]: ◻
        - button "Close" [ref=e168]: ✕
    - generic [ref=e170]: 👋 Hi! Type 'Hi' to start a conversation.
    - generic [ref=e171]:
      - textbox "Type your message..." [ref=e172]
      - button "Send" [ref=e173] [cursor=pointer]
  - generic [ref=e174]:
    - link "Donate Now" [ref=e175] [cursor=pointer]:
      - /url: Donate-Now.html
    - text: "|"
    - link "Test API's" [ref=e176] [cursor=pointer]:
      - /url: API-Test-Playground.html
    - text: "|"
    - link "Medium Articles" [ref=e177] [cursor=pointer]:
...
> 22 |         await page.waitForEvent('download'),
  ...
  25 |     ])
  26 | 
  27 |     console.log("downloadedf file name is ", +download.suggestedFilename());
  28 | 
