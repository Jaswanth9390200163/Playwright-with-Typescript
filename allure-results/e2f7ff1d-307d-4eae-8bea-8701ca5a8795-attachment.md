        ...
        - generic [ref=e28]:
          ...
          - generic [ref=e79]:
            ...
            - generic [ref=e85]:
              ...
              - generic [ref=e87]:
                - link "Download Excel" [active] [ref=e88] [cursor=pointer]:
                  ...
                  - generic [ref=f9e6]:
                    - generic:
                      ...
                      - generic [ref=f9e10]:
                        ...
                        - generic [ref=f9e14]: 1:09
                        - button "My Ad Center" [ref=f9e16] [cursor=pointer]:
                          - generic [ref=f9e17]:
                            - img
                      - generic [ref=f9e19]: You can skip to video in 1
            - cell "Watch" [ref=e132]:
              - link "Watch":
                  ...
                  - generic [ref=f10e6]:
                    - generic:
                      ...
                      - generic [ref=f10e9]:
                        ...
                        - generic [ref=f10e13]: 0:25
                        - button "My Ad Center" [ref=f10e15] [cursor=pointer]:
                          - generic [ref=f10e16]:
                            - img
                      - generic [ref=f10e18]: You can skip to video in 1
            - cell "Watch" [ref=e137]:
              - link "Watch":
...
```ts
  ...
  25 | 
  26 |     // ])
  27 |     await page.getByRole('link', {name : 'Download Excel' }).click()
  28 | 
  29 | 
> 30 |     console.log("downloaded file name is ", +download.suggestedFilename());
     |                                              ^ ReferenceError: download is not defined
  31 | 
  32 |     await download.saveAs("./downloads/Jaswanth.xlsx");
  33 |     
