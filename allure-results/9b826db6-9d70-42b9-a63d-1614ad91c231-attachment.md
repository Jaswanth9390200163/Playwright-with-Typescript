...
Locator: getByText('Mocking')
Expected: visible
Error: strict mode violation: getByText('Mocking') resolved to 2 elements:
    ...
    2) <li>Mocking</li> aka getByText('Mocking', { exact: true })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Mocking')
...
```ts
  ...
  27 |     
  28 |     await expect(page.getByText('Playwright', {exact : true})).toBeVisible();
  29 | 
